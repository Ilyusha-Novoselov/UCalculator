...
std::string UCalculator::CControl::DoEditorCommand(int command)
{
    _state = cEditing;
...
void UCalculator::CControl::DoProcessorCommand(int command)
{
    std::string edit;
...
uint8_t UCalculator::CControl::DoMemoryCommand(int command)
{
...
void UCalculator::CControl::DoReset(bool flag)
{
    _editor->Clear();
    _processor->reset();
    if(flag)
